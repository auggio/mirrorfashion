            ...
            <div class="produto">
                ...
                <form action="checkout.php" method="POST">
                    <fieldset class="cores">
                        ...
                        <label for="verde">
                            <img src="img/produtos/foto5-verde.png" alt="verde">
                        </label>
                        <input type="radio" name="cor" value="rosa" id="rosa">
                        <label for="rosa">
                            <img src="img/produtos/foto5-rosa.png" alt="rosa">
                        </label>
                        <input type="radio" name="cor" value="azul" id="azul">
                        <label for="azul">
                            <img src="img/produtos/foto5-azul.png" alt="azul">
                        </label>
                    </fieldset>
                    ...
                    <input type="hidden" name="numprod" value="5">
